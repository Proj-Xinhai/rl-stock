'''
This file is a copy of deprecated file /sb_up_or_down.py
'''
...
if __name__ == '__main__':
    ...
    '''
    model = RecurrentPPO('MlpLstmPolicy', env, learning_rate=3e-6, verbose=1, tensorboard_log='./ppo_up_or_down_tensorboard') # , n_steps=1205
    model.learn(total_timesteps=1_000_000, progress_bar=True)

    # model.save('ppo_up_or_down7') # e3-4
    # model.save('ppo_up_or_down9') # e3-5 100_000
    # model.save('ppo_up_or_down10') # e3-6 1_000_000
    model.save('ppo_up_or_down11') # e3-6 1_000_000
    ...
    model = RecurrentPPO.load('ppo_up_or_down11')
